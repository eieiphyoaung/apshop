                ...
                <table class="table table-bordered">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo escape(substr($result['description'],0,200)); ?></td>
                      <td>
                          <div class="btn-group">
                              <div class="container">
                                  <a href="category_edit.php?id= <?php echo $result['id']; ?>" type="button" class="btn btn-warning">Edit</a>
                              </div>
                              <div class="container">
                                  <a href="category_delete.php?id= <?php echo $result['id']; ?>"
